...
//    }
     ...
     */
    public void generateVennDiagram (String filePath, String[] sets)
        ...
        System.out.println(dem.readColumnData(dem.convertToMap(file), sets[0]));
    }
//    public ObjectNode generateVennDiagram(String filePath, String srcNodeFtr, String trgtNodeFtr, String strngthFtr)
//            throws JsonProcessingException, IOException, ParseException {
//        ObjectNode res = null;
//        int ndUniqueId = 1;
//        int tripUniqueId = 1;
